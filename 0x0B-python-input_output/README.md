...
<p>At the end of this project, you are expected to be able to <a href="/rltoken/3sv5NWm3hk4WBOLpkFm63w" title="explain to anyone" target="_blank">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
...
<p><a href="/rltoken/OoXim00CJiLcS4PQgOyVSA" title="Justin Marsh" target="_blank">Justin Marsh</a> for the “Automate the Boring Stuff with Python” book rec</p>
