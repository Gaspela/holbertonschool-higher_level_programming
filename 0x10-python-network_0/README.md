...
<ul>
<li><a href="/rltoken/UGtqGaRv-IUx4V7_d4HyRQ" title="HTTP (HyperText Transfer Protocol)" target="_blank">HTTP (HyperText Transfer Protocol)</a> (<em>except: “TRACE” Request Method, “CONNECT” Request Method, Language Negotiation and “Options MultiView” and Character Set Negotiation</em>)</li>
<li><a href="/rltoken/ubO0VPV2T3D77jyfc0c1Xw" title="HTTP Cookies" target="_blank">HTTP Cookies</a> </li>
<li><a href="/rltoken/gX7yM0UgO5mrYSyqlEYzgQ" title="Using cURL to debug" target="_blank">Using cURL to debug</a> </li>
</ul>

<h2>Learning Objectives</h2>

<p>At the end of this project, you are expected to be able to <a href="/rltoken/jgv_SB1xeGngzeB6Mh6RQw" title="explain to anyone" target="_blank">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
...
<li>All <code>curl</code> commands must be have the option <code>-s</code> (silent mode)</li>
